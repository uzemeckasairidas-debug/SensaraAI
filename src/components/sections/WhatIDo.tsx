        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">{d.forWhoTitle}</h3>
              <ul className="space-y-4">
                {d.forWhoItems.map((item) => (
                  <li key={item} className="flex items-start gap-3 text-white/70 leading-relaxed">
                    <div className="w-1.5 h-1.5 rounded-full bg-accent-400 mt-2.5 shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
          ...
          <Card className="relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">{d.howTitle}</h3>
              <p className="text-white/60 leading-relaxed">{d.howText}</p>
            </div>
          </Card>
        </div>
      </div>
